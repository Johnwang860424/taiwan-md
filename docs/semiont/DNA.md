...
| Factcheck audit | [`FACTCHECK-PIPELINE.md`](../pipelines/FACTCHECK-PIPELINE.md)                  | 完整事實查核方法論（Phase 1-6 / 8 atom 類 / 11 hallucination pattern / 6 drift modes）— REWRITE Stage 3.5/3.6 的完整版 |
